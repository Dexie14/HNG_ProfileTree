  ...
  return (
    <div className="Contact">
        ...
        <div className="Message">
                <label>Message</label>
                <textarea id="message" required name="message" placeholder="Send me a message and I'll reply you as soon as possible..." rows="7" cols="50" />
        </div>
        <div className="checkbox">
            <input type="checkbox" id="checkbox" required/>
            <p>You agree to providing your data to Adelu Adeoniye who may contact you.</p>
        </div>
